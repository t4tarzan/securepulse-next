...
export function AlertStatsCards({ open, acknowledged, resolved, total, critical }: AlertStatsCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-5">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-yellow-500">{acknowledged}</div>
